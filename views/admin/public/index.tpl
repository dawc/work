...
<body class="easyui-layout" style="text-align:left">
    <div region="north" border="false" style="overflow: hidden; width: 100%; height:45px; background:#6caef5;">
        <div style="padding-left:5px; float:left; line-height:45px;">
            <span style="font-size:18px;font-weight:bold">Beego管理后台</span>
        </div>
        <!--<ul class="ht_nav">
            {{range .groups}}
        ...
        <div id="header-inner" style="float:right; overflow:hidden; line-height:45px; padding-right:20px; ">
            欢迎你！ {{.userinfo.Nickname}} <a href="javascript:void(0);" onclick="modifypassword()"> 修改密码</a>
            <a href="/manage/admin/public/logout" target="_parent"> 退 出</a>
        </div>
    </div>
    ...
    <div region="west" border="false" split="true" title="菜单"  tools="#toolbar" style="width:200px;padding:5px;border-right:1px solid #daeef5;">
        <ul id="tree"></ul>
    </div>
